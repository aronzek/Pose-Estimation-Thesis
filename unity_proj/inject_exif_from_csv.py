...
def main():
    csv_path = "SyntheticExports/gps_info.csv"
...
"""
Docker commands for the images

Check Docker version
docker --version
Go to Folder
cd "C:\Users\aronj\Desktop\Final Inland"
Create a test folder with 10 images

mkdir SyntheticExports/images_test
copy SyntheticExports/images/img_000*.jpg SyntheticExports/images_test/

Run docker for the 10 images to vslidate for exif, ODM and aligned outputs

docker run -ti --rm ^
-v %cd%/SyntheticExports/images_test:/code/images ^
-v %cd%/odm_test:/code/odm_output ^
opendronemap/odm

Run for all images for 6-12 hours

docker run -ti --rm ^
-v %cd%/SyntheticExports/images:/code/images ^
-v %cd%/odm_output:/code/odm_output ^
opendronemap/odm
"""